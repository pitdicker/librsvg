...
rsvg_node_group_set_atts (RsvgNode * self, RsvgHandle * ctx, RsvgPropertyBag * atts)
{
    ...
    if (rsvg_property_bag_size (atts)) {
        ...
        rsvg_set_presentation_props (ctx, self->state, "g", klazz, id, atts);
    }
}
...
rsvg_node_use_draw (RsvgNode * self, RsvgDrawingCtx * ctx, int dominate)
{
    ...
    double x, y, w, h;
    x = rsvg_normalize_length (&use->x, ctx, HORIZONTAL);
    y = rsvg_normalize_length (&use->y, ctx, VERTICAL);
    w = rsvg_normalize_length (&use->w, ctx, HORIZONTAL);
    h = rsvg_normalize_length (&use->h, ctx, VERTICAL);
...
rsvg_node_svg_draw (RsvgNode * self, RsvgDrawingCtx * ctx, int dominate)
{
    ...
    nx = rsvg_normalize_length (&sself->x, ctx, HORIZONTAL);
    ny = rsvg_normalize_length (&sself->y, ctx, VERTICAL);
    nw = rsvg_normalize_length (&sself->w, ctx, HORIZONTAL);
    nh = rsvg_normalize_length (&sself->h, ctx, VERTICAL);
...
_rsvg_node_svg_apply_atts (RsvgNodeSvg * self, RsvgHandle * ctx)
{
    ...
    if (self->atts && rsvg_property_bag_size (self->atts)) {
        ...
        if ((value = rsvg_property_bag_lookup (self->atts, "id")))
            id = value;
        rsvg_set_presentation_props (ctx, ((RsvgNode *)self)->state, "svg", klazz, id, self->atts);
    }
}
...
rsvg_node_use_set_atts (RsvgNode * self, RsvgHandle * ctx, RsvgPropertyBag * atts)
{
    ...
    if (rsvg_property_bag_size (atts)) {
        ...
        rsvg_set_presentation_props (ctx, self->state, "use", klazz, id, atts);
    }
...
rsvg_node_symbol_set_atts (RsvgNode * self, RsvgHandle * ctx, RsvgPropertyBag * atts)
{
    ...
    if (rsvg_property_bag_size (atts)) {
        ...
        rsvg_set_presentation_props (ctx, self->state, "symbol", klazz, id, atts);
    }
